...
Ответь СТРОГО валидным JSON (без markdown, без ``` и без текста вокруг).
...
{{
  ...
  "author": "...",
  "genre": "...",
  "why": "кратко почему подойдёт"
}}

Правила:
- Ровно 5 книг.
- Не повторяй уже прочитанные/оценённые книги из профиля.
- Не предлагай одну и ту же книгу дважды.
""".strip()
